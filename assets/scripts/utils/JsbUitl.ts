...
//             ListenerMgr.create(
//                 () => {
//                     DialogMgr.showToast(LangMgr.sentence('e0010'))
...
//             ListenerMgr.create(
//                 (launch: afLaunchData) => {
//                     if (SysConfig.isNormalPkg) return;
//                     let { ic, ict, media_source } = launch
...
//                     app_package_name: "luckywinner.website"
//                 });
